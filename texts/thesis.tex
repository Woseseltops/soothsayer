...
grammatical constructions ('\emph{noun} of the \emph{noun}',  'will' vs 'going to', usage of the passive, etc.), and shows similar results.
...
%TODO
% Consistent zijn in model, corpus, training material, text, idiolect vs personal
% Grafieken centreren
