...
def simulate(model,lexicon,content_rb,teststring,settings,nr,result):
    ...
    for i in range(starting_point,len(teststring)):
        ...
        if not already_predicted:
            ...
            current_word = stringtools.find_current_word(teststring,i)
            ...
            if current_word == prediction['full_word']:
                ...
                keystrokes_saved = stringtools.calculate_keystrokes_saved(prediction['word_so_far'],current_word)
                ...
                keystrokes_saved = stringtools.calculate_keystrokes_saved(prediction['word_so_far'],prediction['second_guess'])
                ...
                keystrokes_saved = stringtools.calculate_keystrokes_saved(prediction['word_so_far'],prediction['third_guess'])
